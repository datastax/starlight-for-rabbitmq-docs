...
//Move image to the {product} main index page
...
This section explains how to use your {pulsar-short} tenant's connection details with a RabbitMQ client to produce and consume messages with {starlight-rabbitmq}.
...
//Move to Publishing messages section under {pulsar-short} protocol handler in {product} docs.
